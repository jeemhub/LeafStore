    ...
    className='flex justify-center items-center w-full h-screen'>
        <div className='md:flex shadow-md w-5/6 h-4/5 -mt-16 shadow-orange-400 rounded-2xl'>
            ...
            <div className='flex flex-col w-full items-center md:items-end justify-start md:p-20 py-5'>
                ...
                <input className='md:m-5 m-2 md:w-4/5 w-10/12  border-2 border-solid border-orange-200 rounded-lg p-4' type={'email'} placeholder=' الرقم ...'></input>
                <input className='md:m-5 m-2 md:w-4/5 w-10/12  border-2 border-solid border-orange-200 rounded-lg p-4' type={'text'} placeholder='العنوان...'></input>
